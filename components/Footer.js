                        ...
                        <div className="p-5">
                            <div className={'md:flex md:flex-wrap md:-mx-4 py-6 m-4'}>
                                ...
                                <div className="md:w-[30%] md:px-4">
                                    ...
                                    <form>
                                        <div className="mb-4">
                                            <input className="focus:border-none focus:outline-none p-2 bg-gray-950 shadow-gray-800 shadow-sm w-full rounded" type="text" placeholder="Name" />
                                        </div>
                                        <div className="mb-4">
                                            <input className="focus:border-none focus:outline-none p-2 bg-gray-950 shadow-gray-800 shadow-sm w-full rounded" type="text" placeholder="Email" />
                                        </div>
                                        <div className="mb-4">
                                            <textarea className="focus:border-none focus:outline-none p-2 bg-gray-950 resize-none shadow-gray-800 shadow-sm w-full rounded" rows={5} placeholder="Message"></textarea>
                                        </div>
                                        <div className="flex justify-center">
                                            <button className="text-white px-4 py-2 text-xl transition-all duration-500 text-white bg-gray-950 shadow-sm shadow-gray-800 rounded-md hover:scale-110 active:scale-90">
                                                Send
                                            </button>
                                        </div>
                                    </form>
